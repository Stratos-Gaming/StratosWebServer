"""
Django settings for StratosServer project.
...
SECRET_KEY = 'django-insecure-q$!*s*s(35i%zz7(*rdog5r=837)1!)!ue*_r!&bed3ewto+dq'
...
ROOT_URLCONF = 'StratosServer.urls'
...
WSGI_APPLICATION = 'StratosServer.wsgi.application'
